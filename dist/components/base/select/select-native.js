...
export const NativeSelect = (_a) => {
    var { label, hint, options, className, selectClassName, size = "md" } = _a, props = __rest(_a, ["label", "hint", "options", "className", "selectClassName", "size"]);
    const id = useId();
    const selectId = `select-native-${id}`;
    const hintId = `select-native-hint-${id}`;
    return (_jsxs("div", { className: cx("w-full in-data-input-wrapper:w-max", className), children: [label && (_jsx(Label, { htmlFor: selectId, id: selectId, className: "mb-1.5", children: label })), _jsxs("div", { className: "relative grid w-full items-center", children: [_jsx("select", Object.assign({}, props, { id: selectId, "aria-describedby": hintId, "aria-labelledby": selectId, className: cx("appearance-none rounded-lg bg-primary font-medium text-primary shadow-xs ring-1 ring-primary outline-hidden transition duration-100 ease-linear ring-inset placeholder:text-fg-quaternary focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-50", styles[size].root, 
                        ...
                        "in-data-input-wrapper:in-data-trailing:in-data-[input-size=lg]:pr-8 in-data-input-wrapper:in-data-trailing:in-data-[input-size=md]:pr-7.5 in-data-input-wrapper:in-data-trailing:in-data-[input-size=sm]:pr-6.5", selectClassName), children: options.map((opt) => (_jsx("option", { value: opt.value, children: opt.label }, opt.value))) })), _jsx(ChevronDown, { "aria-hidden": "true", className: cx("pointer-events-none absolute text-fg-quaternary", styles[size].icon, 
                        ...
                        // For "trailing" dropdown within `InputGroup`
                        "in-data-input-wrapper:in-data-trailing:in-data-[input-size=md]:right-3 in-data-input-wrapper:in-data-trailing:in-data-[input-size=sm]:right-3") })] }), hint && (_jsx(HintText, { className: "mt-2", id: hintId, children: hint }))] }));
};
