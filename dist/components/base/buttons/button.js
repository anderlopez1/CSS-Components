...
export const Button = (_a) => {
    var { size = "sm", color = "primary", children, className, noTextPadding, iconLeading: IconLeading, iconTrailing: IconTrailing, isDisabled: disabled, isLoading: loading, showTextWhileLoading } = _a, otherProps = __rest(_a, ["size", "color", "children", "className", "noTextPadding", "iconLeading", "iconTrailing", "isDisabled", "isLoading", "showTextWhileLoading"]);
    ...
    let props = {};
    if (href) {
        props = Object.assign(Object.assign({}, otherProps), { href: disabled ? undefined : href });
    }
    else {
        props = Object.assign(Object.assign({}, otherProps), { type: otherProps.type || "button", isPending: loading });
    }
    return (_jsxs(Component, Object.assign({ "data-loading": loading ? true : undefined, "data-icon-only": isIcon ? true : undefined }, props, { isDisabled: disabled, className: cx(styles.common.root, styles.sizes[size].root, styles.colors[color].root, isLinkType && styles.sizes[size].linkRoot, (loading || (href && (disabled || loading))) && "pointer-events-none", 
        // If in `loading` state, hide everything except the loading icon (and text if `showTextWhileLoading` is true).
        loading && (showTextWhileLoading ? "[&>*:not([data-icon=loading]):not([data-text])]:hidden" : "[&>*:not([data-icon=loading])]:invisible"), className), children: [isValidElement(IconLeading) && IconLeading, isReactComponent(IconLeading) && _jsx(IconLeading, { "data-icon": "leading", className: styles.common.icon }), loading && (_jsxs("svg", { fill: "none", "data-icon": "loading", viewBox: "0 0 20 20", className: cx(styles.common.icon, !showTextWhileLoading && "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"), children: [_jsx("circle", { className: "stroke-current opacity-30", cx: "10", cy: "10", r: "8", fill: "none", strokeWidth: "2" }), _jsx("circle", { className: "origin-center animate-spin stroke-current", cx: "10", cy: "10", r: "8", fill: "none", strokeWidth: "2", strokeDasharray: "12.5 50", strokeLinecap: "round" })] })), children && (_jsx("span", { "data-text": true, className: cx("transition-inherit-all", !noTextPadding && "px-0.5"), children: children })), isValidElement(IconTrailing) && IconTrailing, isReactComponent(IconTrailing) && _jsx(IconTrailing, { "data-icon": "trailing", className: styles.common.icon })] })));
};
