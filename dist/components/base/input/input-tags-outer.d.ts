...
export declare const InputTagsOuter: ({ size, label, hint, tooltip, placeholder, isRequired, isDisabled, isInvalid, allowDuplicates, maxTags, value, defaultValue, onChange, onTagAdded, onTagRemoved, validate, className, hideRequiredIndicator, }: InputTagsOuterProps) => import("react").JSX.Element;
//# sourceMappingURL=input-tags-outer.d.ts.map