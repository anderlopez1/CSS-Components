...
export const FeaturedIcon = (props) => {
    const { size = "sm", theme: variant = "light", color = "brand", icon: Icon } = props, otherProps = __rest(props, ["size", "theme", "color", "icon"]);
    return (_jsxs("div", Object.assign({}, otherProps, { "data-featured-icon": true, className: cx("relative flex shrink-0 items-center justify-center", iconsSizes[size], styles[variant].base, styles[variant].sizes[size], styles[variant].colors[color], props.className), children: [isReactComponent(Icon) && _jsx(Icon, { "data-icon": true, className: "z-1" }), isValidElement(Icon) && _jsx("div", { className: "z-1", children: Icon }), props.children] })));
};
