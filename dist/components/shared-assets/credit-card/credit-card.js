...
const _NORMAL_TYPES = ["transparent", "transparent-gradient", "brand-dark", "brand-light", "gray-dark", "gray-light"];
const STRIP_TYPES = ["transparent-strip", "gray-strip", "gradient-strip", "salmon-strip"];
const VERTICAL_STRIP_TYPES = ["gray-strip-vertical", "gradient-strip-vertical", "salmon-strip-vertical"];
const CARD_WITH_COLOR_LOGO = ["brand-dark", "brand-light", "gray-dark", "gray-light"];
const calculateScale = (desiredWidth, originalWidth, originalHeight) => {
...
export const CreditCard = ({ company = "Untitled.", cardNumber = "1234 1234 1234 1234", cardHolder = "OLIVIA RHYE", cardExpiration = "06/28", type = "brand-dark", className, width, }) => {
    ...
    return (_jsx("div", { style: {
        ...
        }, className: cx("relative flex", className), children: _jsxs("div", { style: {
                transform: `scale(${scale})`,
                width: `${originalWidth}px`,
                height: `${originalHeight}px`,
            }, className: cx("absolute top-0 left-0 flex origin-top-left flex-col justify-between overflow-hidden rounded-2xl p-4", styles[type].root), children: [STRIP_TYPES.includes(type) && (_jsx("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 z-0 h-1/2 bg-neutral-800" })), VERTICAL_STRIP_TYPES.includes(type) && (_jsx("div", { className: "pointer-events-none absolute inset-y-0 right-22 left-0 z-0 bg-neutral-800" })), type === "transparent-gradient" && (_jsxs("div", { className: "absolute -top-4 -left-4 grid grid-cols-2 blur-3xl", children: [_jsx("div", { className: "size-20 rounded-tl-full bg-pink-500 opacity-30 mix-blend-normal" }), _jsx("div", { className: "size-20 rounded-tr-full bg-orange-500 opacity-50 mix-blend-normal" }), _jsx("div", { className: "size-20 rounded-bl-full bg-blue-500 opacity-30 mix-blend-normal" }), _jsx("div", { className: "bg-green-500 size-20 rounded-br-full opacity-30 mix-blend-normal" })] })), _jsxs("div", { className: "relative flex items-start justify-between px-1 pt-1", children: [_jsx("div", { className: cx("text-md leading-[normal] font-semibold", styles[type].company), children: company }), _jsx(PaypassIcon, { className: styles[type].paypassIcon })] }), _jsxs("div", { className: "relative flex items-end justify-between gap-3", children: [_jsxs("div", { className: "flex min-w-0 flex-col gap-2", children: [_jsxs("div", { className: "flex items-end gap-1", children: [_jsx("p", { style: {
                                                wordBreak: "break-word",
                                            }, className: cx("text-xs leading-snug font-semibold tracking-[0.6px] uppercase", styles[type].footerText), children: cardHolder }), _jsx("p", { className: cx("ml-auto text-right text-xs leading-[normal] font-semibold tracking-[0.6px] tabular-nums", styles[type].footerText), children: cardExpiration })] }), _jsxs("div", { className: cx("text-md leading-[normal] font-semibold tracking-[1px] tabular-nums", styles[type].footerText), children: [cardNumber, _jsx("span", { className: "pointer-events-none invisible inline-block w-0 max-w-0 opacity-0", children: "1" })] })] }), _jsx("div", { className: cx("flex h-8 w-11.5 shrink-0 items-center justify-center rounded", styles[type].cardTypeRoot), children: CARD_WITH_COLOR_LOGO.includes(type) ? _jsx(MastercardIcon, {}) : _jsx(MastercardIconWhite, {}) })] })] }) }));
};
