...
export declare const ChartTooltipContent: ({ active, payload, label, isRadialChart, isPieChart, formatter, labelFormatter }: ChartTooltipContentProps) => import("react").JSX.Element | null;
interface ChartActiveDotProps extends DotProps {
    payload?: any;
}
export declare const ChartActiveDot: ({ cx, cy }: ChartActiveDotProps) => import("react").JSX.Element;
export {};
//# sourceMappingURL=charts-base.d.ts.map