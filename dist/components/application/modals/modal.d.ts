...
export declare const ModalOverlay: (props: AriaModalOverlayProps) => import("react").JSX.Element;
export declare const Modal: (props: AriaModalOverlayProps) => import("react").JSX.Element;
export declare const Dialog: (props: AriaDialogProps) => import("react").JSX.Element;
