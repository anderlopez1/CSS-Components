...
export const PaginationLine = (_a) => {
    var { framed, className, size = "md" } = _a, props = __rest(_a, ["framed", "className", "size"]);
    const sizes = {
        md: {
